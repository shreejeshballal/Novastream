...
import { Space1,Space } from "../assets";
	...
	return (
		<div className="h-[100vh] overflow-hidden">
			...
			<div className="w-full h-full flex flex-col items-center justify-center">
                ...
                <button className="bg-dark-gray my-3 px-5 py-2 rounded-md text-light-gray hover:bg-light-gray hover:text-dark-gray transition-all cursor-pointer">
