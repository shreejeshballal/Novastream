    ...
    >
      ...
      >
        ...
        <button
          ...
          key={allState.id}
          className={`bg-dark-gray py-2 w-fit px-3  text-slate-300 rounded-lg flex items-center justify-center hover:bg-light-gray transition-all cursor-pointer ${
            allState.active ? " bg-[#3E393A] " : ""
          }}`}
        >
          {allState.name}
        </button>
